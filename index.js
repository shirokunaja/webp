...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["Hamz botz", "Dekstop", "3.0"]})
...
msg = denz.messages[0]
nomorOwner = ['6281349440547','6281349440547']
nomorDeveloper = ['6281349440547']
